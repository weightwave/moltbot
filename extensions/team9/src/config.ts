...
/**
 * Get Team9 config from Moltbot config
 */
export function getTeam9Config(cfg: MoltbotConfig): Team9Config | undefined {
 ...
 */
export function listTeam9AccountIds(cfg: MoltbotConfig): string[] {
 ...
 */
export function getDefaultTeam9AccountId(cfg: MoltbotConfig): string {
...
/**
 * Apply account config to Moltbot config
 */
